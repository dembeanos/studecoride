    ...
    <ul class="menu-list" id="menuList">
        ...
        <?php if (isset($_SESSION['adminId'])): ?>
            ...
            <li class="menu">
                ...
                <a href="/pages/Admin/Admin.php" title="Profil Admin">Mon Profil</a>
            </li>
        <?php elseif (isset($_SESSION['employeId'])): ?>
            ...
            <li class="menu">
                <img class="icon" src="/assets/images/menu_icon/connectYou.svg">
                <a href="/pages/employe/employe.php" title="Profil Employé">Mon Profil</a>
            </li>
        <?php elseif (isset($_SESSION['userId'])): ?>
            ...
            <li class="menu">
                <img class="icon" src="/assets/images/menu_icon/connectYou.svg">
                <a href="/pages/user/profil.php" title="Profil Utilisateur">Mon Profil</a>
            </li>
        <?php else: ?>
            <li class="menu">
                <img class="icon" id="connectIcon" src="/assets/images/menu_icon/connectYou.svg">
                <a href="/pages/connexion/connexion.php" title="Se connecter">Vous Connecter</a>
            </li>
        <?php endif; ?>

        <?php if (isset($_SESSION['userId']) || isset($_SESSION['employeId']) || isset($_SESSION['adminId'])): ?>
            <li class="menu"><img class="icon" src="/assets/images/menu_icon/logout.svg">
        ...
        <li id="contact" class="menu"><img class="icon" src="/assets/images/menu_icon/contactUs.svg">
            <a href="/pages/contact/contact.php" title="Contactez-nous">Contactez-Nous</a>
        </li>
    </ul>
</nav>
